          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="rounded-lg border p-4 bg-muted/50">
              ...
              <div className="text-sm text-muted-foreground">
                Current Stock: <span className="font-medium">{currentQuantity} {product.metric}</span>
              </div>
              <div className="text-sm text-muted-foreground">
            ...
            {/* Adjustment Preview */}
            {newQuantity && !isNaN(parseFloat(newQuantity)) && difference !== 0 && (
              <Alert className={isIncrease ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'}>
                <div className="flex items-center gap-2">
                  ...
                  <AlertDescription className={isIncrease ? 'text-green-800' : 'text-red-800'}>
                    {isIncrease ? 'Increase' : 'Decrease'} of{' '}
                    <span className="font-semibold">
                      {Math.abs(difference)} {product.metric}
                    </span>
                  </AlertDescription>
                </div>
              </Alert>
            ...
            {/* Low Stock Warning */}
            {newQty <= product.minStockLevel && newQty > 0 && (
            ...
            <DialogFooter>
              ...
              <Button
                type="submit"
                disabled={isAdjusting || difference === 0}
              >
