...
import { Package, AlertTriangle, CheckCircle, XCircle, Settings, Eye } from 'lucide-react';
      ...
      <Card className={className}>
        <CardContent className="flex items-center justify-center py-8">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">Failed to load stock levels</p>
      ...
      {stockLevels.map((item) => (
        <div
          ...
          className={cn(
            ...
            item.stockStatus === 'out-of-stock' ? 'bg-red-50 border-red-200' :
            item.stockStatus === 'low-stock' ? 'bg-yellow-50 border-yellow-200' :
            'bg-white'
          )}
        >
          <div className="flex items-center gap-4 flex-1">
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">{item.group.name}</p>
            </div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  className={cn(
                    ...
                    item.stockStatus === 'out-of-stock' ? 'bg-red-500' :
